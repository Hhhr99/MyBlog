module.exports = {
    ...
    themeConfig: {
        ...
        nav: [
            ...
            {text: 'GitHub', link: 'https://github.com/Hhhr99/MyBlog', icon: 'reco-github'}
        ],
        friendLink: [
            {
                title: '午后南杂',
        ...
        // 访问量
        valineConfig: {
            appId: '64EdUR2zwWt06sOUtDuuzrDA-gzGzoHsz',// your appId
            appKey: 'dwBjDrnlxXbo3c8sETQlYzRr', // your appKey
